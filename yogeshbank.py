...
class SMS:
    ...
    def __init__(self, root):
        ...
        self.student_table.heading('Degree', text="Role")
...
root = Tk()
root.title("Bank data informartion")
root.geometry("630x700")

label_0 = Label(root, text="Bank Data Management System", width=40, font=("Times New Roman", 25),
